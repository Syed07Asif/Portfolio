 ...
 * <a>, nothing nested inside it is itself focusable) with an explicit
 * `aria-label` so its accessible name is just the project name, not every
 * visible string on the card concatenated (the image alt, the description,
 * every tech tag) — see Card's own doc comment on this exact case.
 *
